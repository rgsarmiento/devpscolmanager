                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <template v-if="$page.props.auth.user.role === 'admin'">
                                    ...
                                    <NavLink :href="route('license-packages.index')" :active="route().current('license-packages.*')">
                                        Tarifas
                                    </NavLink>
                                    <NavLink :href="route('debts.index')" :active="route().current('debts.*')">
                                        Cobros
                                    </NavLink>
                                </template>
                            </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <template v-if="$page.props.auth.user.role === 'admin'">
                            ...
                            <ResponsiveNavLink :href="route('license-packages.index')" :active="route().current('license-packages.*')">
                                Tarifas
                            </ResponsiveNavLink>
